        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-8 md:p-12">
              <h2 className="text-3xl font-bold text-black mb-4">¿Tienes una propiedad cerca del Tec?</h2>
              <p className="text-lg text-gray-600 mb-6">
                Publica tu propiedad gratis y conecta con estudiantes verificados que buscan un lugar como el tuyo.
              </p>
              <ul className="mb-8 space-y-2">
                <li className="flex items-center">
                  <svg className="w-5 h-5 mr-2 text-[#FFDC30]" fill="currentColor" viewBox="0 0 20 20">
