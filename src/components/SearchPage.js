...
const SearchPage = ({ onNavigate, initialFilters }) => {
  ...
  const handleViewPropertyDetails = (property) => {
    onNavigate('propertyDetail', property, activeFilters);
  };
            ...
            <div className="mb-4 flex justify-between items-center">
              ...
              <div className="flex space-x-4">
                ...
                <button 
                  ...
                  className="flex items-center px-4 py-2 bg-[#ffd662] text-black rounded-md font-medium hover:bg-yellow-400 transition duration-300"
                >
                  {showMap ? (
                    <>
