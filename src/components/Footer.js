        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/happy.roomie.mx/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#FFDC30]">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/happy.roomie.mx/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#FFDC30]">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.tiktok.com/@happy.roomie.mx" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#FFDC30]">
                <svg className="w-6 h-6" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="150" height="150" rx="20" fill="#E5E5E5"/>
                  <path d="M94.5 41.5c0 7.2 5.8 13 13 13h6.5v13.5c-6.7.1-13.1-1.2-19-3.7v36.2c0 16.6-13.4 30-30 30s-30-13.4-30-30 13.4-30 30-30c2.1 0 4.2.2 6.2.6v14.1c-2-.5-4.1-.7-6.2-.7-8.6 0-15.5 7-15.5 15.5s7 15.5 15.5 15.5 15.5-7 15.5-15.5V20h14.5v21.5z" fill="#111"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">happyroomiemx@gmail.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 text-[#FFDC30] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Av. Gral Ramón Corona No 2514, Colonia Nuevo México, 45201 Zapopan, Jal.</span>
              </li>
            </ul>
          </div>
        </div>
