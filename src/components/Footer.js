      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="text-center md:text-left">
          ...
          <ul className="space-y-2">
            <li><a href="#" className="text-white hover:text-[#ffd662]">Inicio</a></li>
            <li><a href="#" className="text-white hover:text-[#ffd662]">Buscar propiedades</a></li>
            <li><a href="#" className="text-white hover:text-[#ffd662]">Publicar propiedad</a></li>
            <li><a href="#" className="text-white hover:text-[#ffd662]">Encontrar roomie</a></li>
          </ul>
        </div>

        {/* Columna 3: Campus */}
        <div className="text-center md:text-left">
          <h3 className="text-lg font-bold text-[#ffd662] mb-4 font-['Poppins']">Campus</h3>
          <ul className="space-y-2">
            <li><a href="#" className="text-white hover:text-[#ffd662]">Monterrey</a></li>
            <li><a href="#" className="text-white hover:text-[#ffd662]">Ciudad de México</a></li>
            <li><a href="#" className="text-white hover:text-[#ffd662]">Guadalajara</a></li>
            <li><a href="#" className="text-white hover:text-[#ffd662]">Puebla</a></li>
            <li><a href="#" className="text-white hover:text-[#ffd662]">Querétaro</a></li>
          </ul>
        </div>

        {/* Columna 4: Contacto */}
        <div className="text-center md:text-left">
          <h3 className="text-lg font-bold text-[#ffd662] mb-4 font-['Poppins']">Contacto</h3>
          <ul className="space-y-2">
            <li className="flex items-center justify-center md:justify-start">
              <span className="mr-2 text-[#ffd662]">
